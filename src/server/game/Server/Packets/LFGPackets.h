...
namespace WorldPackets
{
    namespace LFG
    {
        ...
        class TC_GAME_API PvpRewardsResponse final : public ServerPacket
        {
        public:
            ...
            LfgPlayerQuestReward reward_0;
            bool unknown = false;
            LfgPlayerQuestReward reward_1;
            LfgPlayerQuestReward reward_2;
            LfgPlayerQuestReward reward_3;
            LfgPlayerQuestReward reward_4;
            LfgPlayerQuestReward reward_5;
            LfgPlayerQuestReward reward_6;
            LfgPlayerQuestReward reward_7;
        };
    }
}
