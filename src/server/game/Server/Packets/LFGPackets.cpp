...
{
    _worldPacket << reward_0;
    _worldPacket.WriteBit(unknown);
    _worldPacket.FlushBits();
    _worldPacket << reward_1;
    _worldPacket << reward_2;
    _worldPacket << reward_3;
    _worldPacket << reward_4;
    _worldPacket << reward_5;
    _worldPacket << reward_6;
    _worldPacket << reward_7;
