...
-- Дамп структуры для таблица auth_ashamane.account
...
-- Дамп данных таблицы auth_ashamane.account: ~0 rows (приблизительно)
DELETE FROM `account`;
...
INSERT INTO `account` (`id`, `username`, `sha_pass_hash`, `sessionkey`, `v`, `s`, `token_key`, `email`, `reg_mail`, `joindate`, `last_ip`, `last_attempt_ip`, `failed_logins`, `locked`, `lock_country`, `last_login`, `online`, `expansion`, `mutetime`, `mutereason`, `muteby`, `locale`, `os`, `recruiter`, `battlenet_account`, `battlenet_index`) VALUES
	(1, '1#1', 'E04B0B8AC631367A839555004ABAE008DB31EB1D', '88292D73C014C90C213E565EF964DB45DC07825A6F39F0B2CA82A85E158E3CC96E8A05AB2917766D', '', '', '', 'ZGN88@MAIL.RU', 'ZGN88@MAIL.RU', '2019-06-05 00:08:59', '127.0.0.1', '127.0.0.1', 0, 0, '00', '2019-06-05 00:10:44', 0, 7, 0, '', '', 8, 'Wn64', 0, 1, 1);
/*!40000 ALTER TABLE `account` ENABLE KEYS */;

-- Дамп структуры для таблица auth_ashamane.account_access
...
-- Дамп данных таблицы auth_ashamane.account_access: ~0 rows (приблизительно)
DELETE FROM `account_access`;
/*!40000 ALTER TABLE `account_access` DISABLE KEYS */;
/*!40000 ALTER TABLE `account_access` ENABLE KEYS */;

-- Дамп структуры для таблица auth_ashamane.account_banned
...
-- Дамп данных таблицы auth_ashamane.account_banned: ~0 rows (приблизительно)
DELETE FROM `account_banned`;
/*!40000 ALTER TABLE `account_banned` DISABLE KEYS */;
/*!40000 ALTER TABLE `account_banned` ENABLE KEYS */;

-- Дамп структуры для таблица auth_ashamane.account_last_played_character
...
-- Дамп данных таблицы auth_ashamane.account_last_played_character: ~1 rows (приблизительно)
...
INSERT INTO `account_last_played_character` (`accountId`, `region`, `battlegroup`, `realmId`, `characterName`, `characterGUID`, `lastPlayedTime`) VALUES
	(1, 1, 1, 1, 'Zgntest', 1, 1559683129);
/*!40000 ALTER TABLE `account_last_played_character` ENABLE KEYS */;

-- Дамп структуры для таблица auth_ashamane.account_muted
...
-- Дамп данных таблицы auth_ashamane.account_muted: ~0 rows (приблизительно)
DELETE FROM `account_muted`;
/*!40000 ALTER TABLE `account_muted` DISABLE KEYS */;
/*!40000 ALTER TABLE `account_muted` ENABLE KEYS */;

-- Дамп структуры для таблица auth_ashamane.autobroadcast
...
-- Дамп данных таблицы auth_ashamane.autobroadcast: ~0 rows (приблизительно)
DELETE FROM `autobroadcast`;
/*!40000 ALTER TABLE `autobroadcast` DISABLE KEYS */;
/*!40000 ALTER TABLE `autobroadcast` ENABLE KEYS */;

-- Дамп структуры для таблица auth_ashamane.battlenet_accounts
...
-- Дамп данных таблицы auth_ashamane.battlenet_accounts: ~0 rows (приблизительно)
...
INSERT INTO `battlenet_accounts` (`id`, `email`, `sha_pass_hash`, `joindate`, `last_ip`, `failed_logins`, `locked`, `lock_country`, `last_login`, `online`, `locale`, `os`, `LastCharacterUndelete`, `LoginTicket`, `LoginTicketExpiry`) VALUES
	(1, 'ZGN88@MAIL.RU', '1636DA39DF379CAD6C89B8C497BDFD6EE1FBD021CFA4EF957B015B459A029E7F', '2019-06-05 00:08:59', '127.0.0.1', 0, 0, '00', '2019-06-05 00:10:40', 0, 8, 'Wn64', 0, 'TC-439A78F02C34698736D3A41FFDDD6CC52C63769A', 1559686240);
/*!40000 ALTER TABLE `battlenet_accounts` ENABLE KEYS */;

-- Дамп структуры для таблица auth_ashamane.battlenet_account_bans
...
-- Дамп данных таблицы auth_ashamane.battlenet_account_bans: ~0 rows (приблизительно)
...
-- Дамп структуры для таблица auth_ashamane.battlenet_account_heirlooms
...
-- Дамп данных таблицы auth_ashamane.battlenet_account_heirlooms: ~0 rows (приблизительно)
...
-- Дамп структуры для таблица auth_ashamane.battlenet_account_mounts
...
-- Дамп данных таблицы auth_ashamane.battlenet_account_mounts: ~0 rows (приблизительно)
...
-- Дамп структуры для таблица auth_ashamane.battlenet_account_toys
...
-- Дамп данных таблицы auth_ashamane.battlenet_account_toys: ~0 rows (приблизительно)
...
-- Дамп структуры для таблица auth_ashamane.battlenet_item_appearances
...
-- Дамп данных таблицы auth_ashamane.battlenet_item_appearances: ~4 rows (приблизительно)
...
-- Дамп структуры для таблица auth_ashamane.battlenet_item_favorite_appearances
...
-- Дамп данных таблицы auth_ashamane.battlenet_item_favorite_appearances: ~0 rows (приблизительно)
...
-- Дамп структуры для таблица auth_ashamane.battle_pets
...
-- Дамп данных таблицы auth_ashamane.battle_pets: ~0 rows (приблизительно)
DELETE FROM `battle_pets`;
/*!40000 ALTER TABLE `battle_pets` DISABLE KEYS */;
/*!40000 ALTER TABLE `battle_pets` ENABLE KEYS */;

-- Дамп структуры для таблица auth_ashamane.battle_pet_slots
...
-- Дамп данных таблицы auth_ashamane.battle_pet_slots: ~3 rows (приблизительно)
...
-- Дамп структуры для таблица auth_ashamane.ip2nation
...
-- Дамп данных таблицы auth_ashamane.ip2nation: ~0 rows (приблизительно)
DELETE FROM `ip2nation`;
/*!40000 ALTER TABLE `ip2nation` DISABLE KEYS */;
/*!40000 ALTER TABLE `ip2nation` ENABLE KEYS */;

-- Дамп структуры для таблица auth_ashamane.ip2nationcountries
...
-- Дамп данных таблицы auth_ashamane.ip2nationcountries: ~0 rows (приблизительно)
...
-- Дамп структуры для таблица auth_ashamane.ip_banned
...
-- Дамп данных таблицы auth_ashamane.ip_banned: ~0 rows (приблизительно)
DELETE FROM `ip_banned`;
/*!40000 ALTER TABLE `ip_banned` DISABLE KEYS */;
/*!40000 ALTER TABLE `ip_banned` ENABLE KEYS */;

-- Дамп структуры для таблица auth_ashamane.logs
...
-- Дамп данных таблицы auth_ashamane.logs: ~0 rows (приблизительно)
DELETE FROM `logs`;
/*!40000 ALTER TABLE `logs` DISABLE KEYS */;
/*!40000 ALTER TABLE `logs` ENABLE KEYS */;

-- Дамп структуры для таблица auth_ashamane.logs_ip_actions
...
-- Дамп данных таблицы auth_ashamane.logs_ip_actions: ~0 rows (приблизительно)
DELETE FROM `logs_ip_actions`;
/*!40000 ALTER TABLE `logs_ip_actions` DISABLE KEYS */;
/*!40000 ALTER TABLE `logs_ip_actions` ENABLE KEYS */;

-- Дамп структуры для таблица auth_ashamane.rbac_account_permissions
...
-- Дамп данных таблицы auth_ashamane.rbac_account_permissions: ~0 rows (приблизительно)
...
-- Дамп структуры для таблица auth_ashamane.rbac_default_permissions
...
-- Дамп данных таблицы auth_ashamane.rbac_default_permissions: ~4 rows (приблизительно)
...
-- Дамп структуры для таблица auth_ashamane.rbac_linked_permissions
...
-- Дамп данных таблицы auth_ashamane.rbac_linked_permissions: ~668 rows (приблизительно)
...
-- Дамп структуры для таблица auth_ashamane.rbac_permissions
...
-- Дамп данных таблицы auth_ashamane.rbac_permissions: ~686 rows (приблизительно)
...
-- Дамп структуры для таблица auth_ashamane.realmcharacters
...
-- Дамп данных таблицы auth_ashamane.realmcharacters: ~1 rows (приблизительно)
...
-- Дамп структуры для таблица auth_ashamane.realmlist
...
-- Дамп данных таблицы auth_ashamane.realmlist: ~0 rows (приблизительно)
...
INSERT INTO `realmlist` (`id`, `name`, `address`, `localAddress`, `localSubnetMask`, `port`, `icon`, `flag`, `timezone`, `allowedSecurityLevel`, `population`, `gamebuild`, `Region`, `Battlegroup`) VALUES
	(1, 'TrinityCoreCustom', '127.0.0.1', '127.0.0.1', '255.255.255.0', 8085, 0, 0, 1, 0, 0, 28153, 1, 1);
/*!40000 ALTER TABLE `realmlist` ENABLE KEYS */;

-- Дамп структуры для таблица auth_ashamane.updates
...
-- Дамп данных таблицы auth_ashamane.updates: 1 rows
DELETE FROM `updates`;
/*!40000 ALTER TABLE `updates` DISABLE KEYS */;
INSERT INTO `updates` (`name`, `hash`, `state`, `timestamp`, `speed`) VALUES
	('2019_06_04_00_auth.sql', '9579FA086A8ED44291314AD0EF08B82FAEECBDC9', 'RELEASED', '2019-06-04 23:57:23', 333);
/*!40000 ALTER TABLE `updates` ENABLE KEYS */;

-- Дамп структуры для таблица auth_ashamane.updates_include
...
-- Дамп данных таблицы auth_ashamane.updates_include: 2 rows
...
-- Дамп структуры для таблица auth_ashamane.uptime
...
-- Дамп данных таблицы auth_ashamane.uptime: ~0 rows (приблизительно)
DELETE FROM `uptime`;
/*!40000 ALTER TABLE `uptime` DISABLE KEYS */;
INSERT INTO `uptime` (`realmid`, `starttime`, `uptime`, `maxplayers`, `revision`) VALUES
	(1, 1559585428, 0, 0, 'TrinityCoreCustom rev. unknown 1970-01-01 00:00:00 +0000 (Archived branch) (Win64, Release, Static)'),
	(1, 1559682319, 743, 1, 'TrinityCore rev. cc74e99d5c06+ 2019-02-15 22:00:12 +0100 (stable_staff branch) (Win64, Release, Static)');
